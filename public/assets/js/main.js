	...
	function loadListings() {
		return new Promise((resolve, reject) => {
			...
			fetch(`/listings`)
				...
				.then((data) => {
					const listings = data.cars // Access the cars array from the response
					const parentElement = document.querySelector('.project-slide1')
        ...
        <div class="project-img" style="width:595px; height:390px; overflow:hidden; position: relative; display: flex; align-items: center; justify-content: center;">
            <img src="${carimage}" style="width:100%; height:100%; object-fit:cover; object-position: center;" alt="${car.make}_${car.model}_${car.vin}_thumbnail" />
            <div class="shape"></div>
            <a href="${carimage}" style="z-level:1" class="project-btn popup-image"><i class="fa-solid fa-arrow-up-right-and-arrow-down-left-from-center"></i> </a>
			<div class="project-btn listHeader">
                <h3 class="listHeaderITMH">${car.year} ${car.make} ${car.model}</h3>
                <h3 class="listHeaderITMsH">$${car.price}</h3>
              </div>
        </div>
    </div>`
						...
						parentElement.appendChild(listing) // Insert the listing into the parent element
					})
					resolve()
				})
				.catch((error) => {
