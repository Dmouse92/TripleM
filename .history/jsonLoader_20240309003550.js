...
let addCont = `
	...
	<div class="formDiv">
	  ...
	  <div class="formDiv">
        ...
        <input class="radioBtn" type="radio" id="manual" name="transmission2" value="Manual">
        <label class="radioLBL" for="manual">Manual</label>
    </div>
    <div class="formDiv">
        <label class="radioLBL" for="drive" class="inpLabel">Drive Type:</label>
        <input class="radioBtn" type="radio" id="fwd" name="drive1" value="FWD">
        <label class="radioLBL" for="fwd">FWD</label>
        <input class="radioBtn" type="radio" id="rwd" name="drive2" value="RWD">
        <label class="radioLBL"  for="rwd">RWD</label>
        <input class="radioBtn" type="radio" id="awd" name="drive3" value="AWD">
