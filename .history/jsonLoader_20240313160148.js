...
function updateOrderNumbers() {
	...
	document.querySelectorAll('.img-wrap').forEach((wrap, index) => {
		...
		if (orderNumber) {
			...
			auxArray[orderPos - 1] = imageFiles[oldPos] // Position the image at the specified order position
			console.log('AUX: ', auxArray[orderPos - 1], 'IMG: ', imageFiles[oldPos], 'ORDER: ', orderPos)
		}
	})
