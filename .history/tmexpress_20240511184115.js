...
const sqlite3 = require('sqlite3').v // Setup multer to store files temporarily in a staging area
...
app.post('/upload', upload.array('images'), async (req, res) => {
	...
	try {
		...
		const uniqueFiles = files.filter(
			(file, index, self) => index === self.findIndex((t) => t.originalname === file.originalname)
		)
