...
function handleFormSubmit(e) {
	...
	const sqmake = document.getElementById('make').value
	const sqmodel = document.getElementById('model').value
	const sqvin = document.getElementById('vin').value

	// Prepare the SQL query
	const query = `INSERT INTO your_table_name (make, model, vin, images) VALUES (?, ?, ?, ?)`

	// Execute the query
	database.run(query, [make, model, vin, formData.getAll('images')])
}
