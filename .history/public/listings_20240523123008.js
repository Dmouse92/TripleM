...
document.addEventListener('DOMContentLoaded', function () {
	...
	function showFullScreenCarousel(startIndex) {
		...
		const emblaNodeThumb = overlay.querySelector('.etvfull')
		...
		const prevBtnNode = document.querySelector('.embla__button--prev-full')
		const nextBtnNode = document.querySelector('.embla__button--next-full')
