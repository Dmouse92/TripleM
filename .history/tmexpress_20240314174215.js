...
// Function to resize and crop image to 1024x1024 and move to a new directory
function resizeAndCropImage(inputPath, newDirectory) {
	// Generate a new output path within the new directory
		...
		sharp(inputPath)
			...
			.toFile(outputPath, (err, info) => {
				if (err) {
					...
					console.log('Image resized and moved successfully:', info)
