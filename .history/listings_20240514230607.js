...
document.addEventListener('DOMContentLoaded', function () {
	...
	const prevBtnNodeF = emblaNodeMain.querySelector('.embla__button--prev-full')
	const nextBtnNodeF = emblaNodeMain.querySelector('.embla__button--next-full')

	prevBtnNodeF.addEventListener('click', embla.scrollPrev)
	nextBtnNodeF.addEventListener('click', embla.scrollNext)
