...
function addCar() {
	...
	mileageInput.addEventListener('focus', function () {
		if (!this.value) {
			this.value = '0 miles'
		}
	})
	mileageInput.addEventListener('blur', function () {
		if (this.value === '0 miles') {
			this.value = ''
		}
	})
}
...
let addCont = `
    ...
    <div class="formDiv">
        ...
        <input class="radioBtn" type="radio" id="4wd" name="drive" value="4WD">
        <label class="radioLBL" for="4wd">4WD</label>
    </div>
	<div class="formDiv">
