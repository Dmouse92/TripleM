...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Grab button nodes
const prevButtonNode = e.querySelector('.embla__prev')
const nextButtonNode = viewportNodeThumbCarouse.querySelector('.embla__next')
// Add click listeners
prevButtonNode.addEventListener('click', emblaApiThumb.scrollPr, false)
