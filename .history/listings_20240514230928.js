...
document.addEventListener('DOMContentLoaded', function () {
	...
	function showFullScreenCarousel(startIndex) {
		...
		const emblaNodeThumb = overlay.querySelector('.etfull')
		...
		const prevBtnNode = emblaNodeMain.querySelector('.embla__button--prev-full')
		const nextBtnNode = emblaNodeMain.querySelector('.embla__button--next-full')
