...
function handleFormRSubmit(e) {
	...
	fetch('http://localhost:3000/preview', {
		...
		.then((data) => {
			...
			prevCont.innerHTML = '' // Clear previous content

			// Create preview elements based on the data received
			let img = document.createElement('img')
			img.src = data.imagePath // Assuming data contains an imagePath property
			...
			confirmButton.onclick = function () {
				...
				fetch('http://localhost:3000/delete-listing', {
					method: 'DELETE',
					headers: {
