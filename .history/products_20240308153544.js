				...
				<div class="team-box" >
					<div class="team-img">
						<img
							...
							title=""
							style="" />
						 <div class="team-content" style="background-color: #0f0; display:flex; flex-direction: column; justify-content: space-between; align-items: space-between; border-radius: 0.5em 0.5em 0 0; border: 0 solid #1f2022">
							<h3 class="team-title">
								<a href="https://themeholy.com/wordpress/malen/team-members/">
									${car.year} ${car.make} ${car.model}
								</a>
							</h3>
							<span style="background-color: #F00;  color: #f6f5f5;font-size:2.5vh; font-weight:700" class="vehicle-desig">$${car.price}</span>
						</div>
					</div>
					<div
